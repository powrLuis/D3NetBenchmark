...
class RgbdToDataset(Dataset):
    ...
    def get_sample(self,index):
        ...
        sample['meta'] = {'id': os.path.splitext(os.path.split(self.depths_list[index])[1])[0]}
        sample['meta']['source_size'] = np.array(depth.shape[::-1])
